package com.flowersshoes.sistemadealmacen.security;
...
public class Constants {
    ...
    // Spring security
    public static final String LOGIN_URL = "/trabajador/login";
    ...
    public static final long TOKEN_EXPIRATION_TIME = 21_600_000; // 6 hours
